...
Scenario: Sign-up Director with existing Email
	Given A Director is already stored
		| FirstName | LastName | Age | Email                  | Password | Phone |
		| Luis      | Castillo | 39  | ric.cruz1212@gmail.com | Pls99281 | 992121083 |
	When A Post Request is Sent
		| FirstName | LastName | Age | Email                  | Password | Phone |
		| Juanito   | Castillo | 40  | ric.cruz1212@gmail.com | Pls99281 | 982182734 |
	Then A Response with Status 400 is Received
	And A Message of "Email ric.cruz1212@gmail.com is already taken." is included in Response Body